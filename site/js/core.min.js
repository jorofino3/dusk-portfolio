...
!(function (e, t, n, o, r) {
  ...
  function ne(e, t) {
    e = le(e) ? e[0] : e;
    for (
      var n = null != t ? X(t, e.parentNode) : e.parentNode.childNodes,
        o = 0,
        r = 0;
      r < n.length;
      r++
  ...
  function me(e, t, n) {
    le(n) || ("string" == typeof n && (n = Ae(n)), (n = [n]));
    ...
    function ($, oe) {
          ...
          Ne &&
            ...
            (ke.destroy = function (n) {
              vt(!1, "internal"),
                ...
                n &&
                  ...
                  Te(X(E + ", " + j + ", " + P)),
                  Q(X(h), { height: "", "background-color": "", padding: "" }),
                  Q(X(M), { width: "" }),
                  Q(Ne, {
                    height: "",
                    position: "",
                  ...
                  Q(Ne, { "-webkit-transition": "none", transition: "none" }),
                  e.scrollTo(0, 0),
            ...
            (ke.test = {
              ...
              translate3dH: (function () {
                for (
                  var e = [], t = 0;
                  t < X(oe.sectionSelector, Ne).length;
                  t++
                )
            ...
            (ke.shared = { afterRenderActions: jt }),
            (e.fullpage_api = ke),
            oe.css3 &&
              (oe.css3 = (function () {
                var n,
            ...
            (function () {
              Q(Ne, { height: "100%", position: "relative" }),
                ae(Ne, n),
                ae(X("html"), a),
                (Pe = K()),
                ce(Ne, l),
              ...
              oe.fixedElements &&
                oe.css3 &&
                X(oe.fixedElements).forEach(function (e) {
                  me.appendChild(e);
                }),
                oe.navigation &&
                  (function () {
                ...
                X('iframe[src*="youtube.com/embed/"]', Ne).forEach(function (
                  e
                ) {
                  var t, n, o;
                  (n = "enablejsapi=1"),
          ...
          ? ((function () {
              ...
              var r =
                "onwheel" in t.createElement("div")
                  ...
                  : "DOMMouseScroll";
              "DOMMouseScroll" == r
                ? t[n](o + "MozMousePixelScroll", Xt, !1)
                : t[n](o + r, Xt, !1);
            })(),
            Ne.addEventListener("mousedown", dn),
            Ne.addEventListener("mouseup", vn))
          : (t.addEventListener
              ? (t.removeEventListener("mousewheel", Xt, !1),
                t.removeEventListener("wheel", Xt, !1),
                t.removeEventListener("MozMousePixelScroll", Xt, !1))
              : t.detachEvent("onmousewheel", Xt),
        ...
        e
          ? (mt(!0),
            (function () {
              if (ze || je) {
                oe.autoScrolling &&
                  (me.removeEventListener(Ze.touchmove, Vt, { passive: !1 }),
                  me.addEventListener(Ze.touchmove, Vt, { passive: !1 }));
                var e = X(o)[0];
                e &&
                  (e.removeEventListener(Ze.touchstart, Ut),
                  e.removeEventListener(Ze.touchmove, Yt, { passive: !1 }),
                  e.addEventListener(Ze.touchstart, Ut),
                  e.addEventListener(Ze.touchmove, Yt, { passive: !1 }));
              }
            })())
          : (mt(!1),
            (function () {
              if (ze || je) {
                oe.autoScrolling &&
                  (me.removeEventListener(Ze.touchmove, Yt, { passive: !1 }),
                  me.removeEventListener(Ze.touchmove, Vt, { passive: !1 }));
                var e = X(o)[0];
                e &&
                  (e.removeEventListener(Ze.touchstart, Ut),
      ...
      function wt(e, t) {
        void 0 !== t
          ...
          : (Dn(e, "all", "k"), (oe.keyboardScrolling = e));
      }
      function yt() {
        var e = G(X(g)[0], h);
      ...
      function Lt(e, t) {
        ht(0, "internal"), xt(e, t), ht(tt.scrollingSpeed, "internal");
      }
      function xt(e, t) {
        var n = Mn(e);
        ...
        if (!q(Ne, l)) {
          ...
          for (var n = X(h), o = 0; o < n.length; ++o) {
            var r = n[o],
              i = X(I, r)[0],
              a = X(M, r);
            oe.verticalCentered && Q(X(S, r), { height: Tn(r) + "px" }),
              Q(r, { height: Pe + "px" }),
          ...
          c && Lt(c + 1),
            ...
            ye(oe.afterResize) &&
              t &&
              oe.afterResize.call(Ne, e.innerWidth, e.innerHeight),
      ...
      function Ot(e) {
        ...
        t && pe(t, E + " a")
          ...
          : pe(t, oe.menu + " [data-menuanchor]") &&
            function (e) {
              !X(oe.menu)[0] ||
                (!oe.lockAnchors && oe.anchors.length) ||
                (we(e), xt(this.getAttribute("data-menuanchor")));
            }.call(t, e);
      }
      function Ct(e, n) {
        (t["fp_" + e] = n), t.addEventListener(e, It, !0);
      }
      function It(e) {
        e.target != t &&
      ...
      function Ht(e, n, o) {
        ...
        (a.className = H),
          ...
          n.forEach(function (e) {
            Q(e, { width: i + "%" }), oe.verticalCentered && An(e);
          });
        var c = X(O, e)[0];
        null != c && (0 !== ne(X(g), h) || (0 === ne(X(g), h) && 0 !== ne(c)))
          ? jn(c, "internal")
          : ae(n[0], s);
      }
      function Bt(e, t) {
        t || null != X(g)[0] || ae(e, s),
          ...
          oe.paddingBottom && Q(e, { "padding-bottom": oe.paddingBottom }),
      ...
      function Rt(e, t) {
        void 0 !== oe.anchors[t] && q(e, s) && Ln(oe.anchors[t], t),
          oe.menu &&
            oe.css3 &&
            null != pe(X(oe.menu)[0], o) &&
            me.appendChild(X(oe.menu)[0]);
      }
      function zt(e, t) {
      ...
      function Nt() {
        ...
        if (!oe.autoScrolling || oe.scrollBar) {
          ...
          if (c) l = u.length - 1;
            ...
            for (var d = 0; d < u.length; ++d) u[d].offsetTop <= a && (l = d);
          else l = 0;
          if (
            ((t = i),
            (n = X(g)[0].offsetTop),
            (o = n + K()),
            ("up" == t ? o >= Se() + K() : n <= Se()) &&
              (q(X(g)[0], f) || (ae(X(g)[0], f), ce(be(X(g)[0]), f))),
            !q((e = u[l]), s))
          ) {
            ot = !0;
            var v,
            ...
            E && ((p = E.getAttribute("data-anchor")), (v = ne(E))),
              Ye &&
                (ae(e, s),
                ce(be(e), s),
      ...
      function Yt(t) {
        ...
        if (Ft(t)) {
          ...
          (at = o.y),
            (ct = o.x),
            X(I, n).length && Math.abs(lt - ct) > Math.abs(it - at)
              ? !Re &&
                Math.abs(lt - ct) >
                  (e.innerWidth / 100) * oe.touchSensitivity &&
                (lt > ct ? Ue.m.right && At(n) : Ue.m.left && Tt(n))
              : oe.autoScrolling &&
                Ye &&
                Math.abs(it - at) >
                  (e.innerHeight / 100) * oe.touchSensitivity &&
                (it > at ? Dt("down") : at > it && Dt("up"));
        }
      }
      function Ft(e) {
      ...
      function Xt(t) {
        var n = new Date().getTime(),
          o = q(X(d)[0], w);
        if (!Ue.m.down && !Ue.m.up) return we(t), !1;
      ...
      function _t(e, t) {
        ...
        if (!(null == o || Re || X(M, o).length < 2)) {
          ...
          (Re = !ke.test.isTesting), mn(o, i, e);
        }
      }
      function qt() {
        for (var e = X(O), t = 0; t < e.length; t++) jn(e[t], "internal");
      }
      function Kt(e, t, n) {
        if (null != e) {
          var o,
          ...
          if (
            !(
              (i.activeSection == e && !De) ||
              (oe.scrollBar && Se() === i.dtop && !q(e, b))
            )
          ) {
            if (
              (null != i.activeSlide &&
            ...
            oe.autoScrolling &&
              ...
              (i = (function (e) {
                return (
                  e.isMovementUp
                    ? ge(X(g)[0], Me(e.activeSection, h))
                    : he(X(g)[0], Oe(e.activeSection, h).reverse()),
                  Nn(X(g)[0].offsetTop),
                  qt(),
      ...
      function Qt(e, t) {
        ...
        if (oe.v2compatible) {
          if (!1 === oe[e].apply(o[0], o.slice(1))) return !1;
        } else if (
          (Ee(Ne, e, o),
          !1 ===
            oe[e].apply(
      ...
      function Zt(e) {
        !(function (e) {
          null != e.wrapAroundElements &&
            (e.isMovementUp
              ? ge(X(h)[0], e.wrapAroundElements)
              : he(X(h)[X(h).length - 1], e.wrapAroundElements),
            Nn(X(g)[0].offsetTop),
            qt());
        })(e),
        ...
        9 === o
          ? (function (e) {
              var n = e.shiftKey,
                ...
                r = pn(ln(X(g)[0]));
              function i(e) {
                return we(e), r[0] ? r[0].focus() : null;
              }
              (function (e) {
                var n = pn(t),
          ...
          : Le(n, "textarea") ||
            ...
            !oe.autoScrolling ||
            ([40, 38, 32, 33, 34].indexOf(o) > -1 && we(e),
            (He = e.ctrlKey),
            ($e = setTimeout(function () {
              !(function (e) {
                var t = e.shiftKey;
      ...
      function dn(e) {
        2 == e.which && ((ft = e.pageY), Ne.addEventListener("mousemove", gn));
      }
      function vn(e) {
      ...
      function gn(e) {
        Ye &&
          (e.pageY < ft && Ue.m.up ? yt() : e.pageY > ft && Ue.m.down && Et()),
          (ft = e.pageY);
      }
      function mn(e, t, n) {
        var o,
        ...
        (l.xMovement =
          ...
          !1 === Qt("onSlideLeave", l)
            ...
            : (ae(t, s),
              ce(be(t), s),
              l.localIsResizing || (rn(l.prevSlide), tn(t)),
              !oe.loopHorizontal &&
                oe.controlArrows &&
                (xe(X(Y, i), 0 !== l.slideIndex), xe(X(U, i), null != ee(t))),
              q(i, s) &&
                !l.localIsResizing &&
                In(l.slideIndex, l.slideAnchor, l.anchorLink, l.sectionIndex),
              (function (e, t, n) {
                var o = t.destinyPos;
                if (oe.css3) {
                  var r =
      ...
      function Sn(e) {
        ...
        (t = e.slidesNav),
          ...
          oe.slidesNavigation &&
            null != t &&
            (ce(X(u, t), s), ae(X("a", X("li", t)[n]), s)),
          e.localIsResizing ||
            (ye(oe.afterSlideLoad) && Qt("afterSlideLoad", e),
            (Ye = !0),
            nn(e.destiny)),
          (Re = !1);
      }
      function bn() {
        if ((wn(), ze)) {
          ...
          if (!Le(e, "textarea") && !Le(e, "input") && !Le(e, "select")) {
            var n = K();
            Math.abs(n - dt) > (20 * Math.max(dt, n)) / 100 &&
              (Xe = setTimeout(
                function () {
                  kt(!0), (dt = n);
                },
      ...
      function Ln(e, t) {
        ...
        (n = e),
          ...
          oe.menu &&
            null != o &&
            (ce(X(u, o), s), ae(X('[data-menuanchor="' + n + '"]', o), s)),
          (function (e, t) {
            oe.navigation &&
              null != X(E)[0] &&
              (ce(X(u, X(E)[0]), s),
      ...
      function On(e, t) {
        ...
        if (null != n) {
          var o = (function (e, t) {
            ...
            return (
              null == n && ((e = void 0 !== e ? e : 0), (n = X(M, t)[e])), n
            );
          })(t, n);
          Bn(n) === Ce || q(n, s)
            ? Cn(o)
      ...
      function Hn(t) {
        ...
        else if (ze || je) e.history.replaceState(void 0, void 0, "#" + t);
        else {
      ...
      function Rn() {
        ...
        (me.className = me.className.replace(i, "")), ae(me, c + "-" + r);
      }
      function zn(e) {
        var t = [];
        return (
      ...
      function Nn(e) {
        ...
        if (oe.css3 && oe.autoScrolling && !oe.scrollBar)
          ...
          Q(Ne, { top: -t + "px" }), (ke.test.top = -t + "px");
        else {
          var n = Jt(t);
      ...
      function Un(t, n) {
        !oe.autoScrolling || oe.scrollBar || (t.self != e && q(t, C))
          ? t.self != e && q(t, C)
            ? (t.scrollLeft = n)
            : t.scrollTo(0, n)
          : (t.style.top = n + "px");
